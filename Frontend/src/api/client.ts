...
export class MatchDto extends EntityBaseDto implements IMatchDto {
    ...
    init(data?: any) {
        ...
        if (data) {
            ...
            this.game1 = data["game1"] ? GameDto.fromJS(data["game1"]) : <any>undefined;
            this.game2 = data["game2"] ? GameDto.fromJS(data["game2"]) : <any>undefined;
            this.game3 = data["game3"] ? GameDto.fromJS(data["game3"]) : <any>undefined;
            this.game4 = data["game4"] ? GameDto.fromJS(data["game4"]) : <any>undefined;
            this.game5 = data["game5"] ? GameDto.fromJS(data["game5"]) : <any>undefined;
        }
    }
